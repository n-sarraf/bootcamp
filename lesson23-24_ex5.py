...
plt.plot(x_high, y_high, marker='.', linestyle='none', markersize=20, alpha=.5)
plt.plot(x_low, y_low, marker='.', linestyle='none', markersize=20, alpha=.5)
plt.plot(x, cdf_high, color='gray')plt.plot(x, cdf_low, color='gray')
